...
const FollowHandler = async (event) => {
    ...
    let response = new tweeter_shared_1.FollowResponse(true, ...await new FollowService_1.FollowService(new DynamoDaoFactory_1.DynamoDaoFactory()).follow(request.authToken, request.user), "Follow successful");
    return response;
};
