...
const FeedHandler = async (event) => {
    ...
    let response = new tweeter_shared_1.LoadMoreItemsResponse(true, ...await new StatusService_1.StatusService().loadMoreFeedItems(request.authToken, request.user, request.pageSize, request.lastItem), "Load more feed items successful");
    return response;
};
